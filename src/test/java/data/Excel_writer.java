...
public class Excel_writer {
	public void writeExcel(String fileName,String sheetName,String[] dataToWrite,int cell_index) throws IOException{
      ...
      //Create a loop over the cell of newly created Row
        ...
        for(int j = 0; j < dataToWrite.length; j++){
            ...
            Cell cell = newRow.createCell(cell_index);
            

            cell.setCellValue(dataToWrite[cell_index]);
